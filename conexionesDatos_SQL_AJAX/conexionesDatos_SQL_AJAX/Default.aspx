<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="conexionesDatos_SQL_AJAX.Default" %>
...
<br />
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="btnBuscarTodos" EventName="Click" />
